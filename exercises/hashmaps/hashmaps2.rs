...
fn fruit_basket(basket: &mut HashMap<Fruit, u32>) {
    ...
    for fruit in fruit_kinds {
        ...
        // already present!
        match fruit {
            Fruit::Apple => basket.entry(Fruit::Apple).or_insert(2),
            Fruit::Banana => basket.entry(Fruit::Banana).or_insert(2),
            Fruit::Mango => basket.entry(Fruit::Mango).or_insert(2),
            Fruit::Lychee => basket.entry(Fruit::Lychee).or_insert(2),
            Fruit::Pineapple => basket.entry(Fruit::Pineapple).or_insert(2),
        };
    }
}
